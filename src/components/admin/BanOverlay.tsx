        ...
        <AnimatePresence>
            {banned && (
                <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="fixed inset-0 z-[99999] bg-black flex items-center justify-center p-4 overflow-hidden font-mono"
                    style={{ pointerEvents: 'all' }}
                >
                    {/* Background Effects */}
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_transparent_0%,_#000_100%)] z-10"></div>
                    <div className="absolute inset-0 bg-[linear-gradient(rgba(255,0,0,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,0,0,0.1)_1px,transparent_1px)] bg-[size:40px_40px] opacity-20 z-0 animate-pulse"></div>
                    <div className="absolute inset-0 bg-red-900/10 z-0"></div>

                    {/* Scanline Overlay */}
                    <div className="absolute inset-0 pointer-events-none z-20 bg-[linear-gradient(transparent_50%,_rgba(0,0,0,0.5)_50%)] bg-[size:100%_4px] opacity-20"></div>
                    ...
                    >
                        ...
                        <div className="relative mb-12 text-center group">
                            {/* Glitch Shadows */}
                            <h1 className="absolute top-0 left-0 w-full text-7xl md:text-9xl font-black text-red-600 opacity-50 blur-[2px] animate-pulse uppercase tracking-tighter select-none scale-[1.02]">
                                TERMINATED
                            </h1>
                            <h1 className="relative text-7xl md:text-9xl font-black text-white uppercase tracking-tighter select-none mix-blend-overlay">
                                TERMINATED
                            </h1>
                            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-red-600 text-black px-4 py-1 font-black text-xs uppercase tracking-[0.5em] rotate-2">
                        ...
                        <div className="bg-black/80 backdrop-blur-2xl border border-red-500/30 rounded-3xl overflow-hidden shadow-[0_0_100px_rgba(220,38,38,0.2)] relative">
                            ...
                            <div className="p-8 md:p-12 relative">
                                ...
                                <div className="mb-8">
                                    ...
                                    <div className="bg-red-500/5 border-l-4 border-red-500 p-6 backdrop-blur-sm">
                                ...
                                <div className="space-y-4">
                                    <a
                                        href="/sign-out"
                                        className="block w-full py-4 bg-red-600 hover:bg-red-500 text-white text-center font-black uppercase tracking-widest rounded-xl transition-all shadow-[0_0_20px_rgba(220,38,38,0.4)] hover:shadow-[0_0_30px_rgba(220,38,38,0.6)] hover:scale-[1.02]"
                                    >
