...
export default function SignUpPage() {
    return (
        <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex items-center justify-center p-8 pt-32 md:p-8 bg-surface relative">
                ...
                <SignUp
                    appearance={{
                        elements: {
                            ...
                            card: 'bg-surface border border-surface-border shadow-2xl rounded-3xl p-8 z-10',
                            ...
                            socialButtonsBlockButton:
                                'bg-surface hover:bg-foreground/5 border border-surface-border text-foreground rounded-xl py-2.5 font-bold transition-all',
