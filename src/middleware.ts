...
const isPublicRoute = createRouteMatcher(['/', '/sign-in(.*)', '/sign-up(.*)', '/verify', '/api/system/config(.*)', '/LaHustle-gate', '/command-center-z', '/become-vendor', '/security-setup', '/api/security(.*)', '/about', '/contact', '/shipping-and-returns', '/terms', '/privacy', '/help', '/api/marketplace(.*)', '/api/products(.*)', '/api/category(.*)', '/api/search(.*)']);
